...
<div class="pre-footer">
  <nav class="container wrapper py-5">
    <ul class="list-group flex-row justify-content-around">
        ...
        <li><a href=""><div class="pre-footer-img-container"><img src="{{Vite::asset("resources/img/buy-comics-shop-locator.png")}}" alt=""></div>COMIC SHOP LOCATOR</a></li>
        <li><a href=""><div class="pre-footer-img-container"><img src="{{Vite::asset("resources/img/buy-dc-power-visa.svg")}}" alt=""></div>DC POWER VISA</a></li>
    </ul>
  </nav>
</div>
...
<section class="post-footer pt-3">
    ...
    <div>
        <button class="px-3 py-1">SIGN UP NOW</button>
    </div>
